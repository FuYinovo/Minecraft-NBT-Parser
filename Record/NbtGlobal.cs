...
public abstract record NbtGlobal
{
    ...
    public static readonly Dictionary<byte, (NbtTagEnum Enum, int fieldSize, bool isDynamic, int? dataLengthMulti)>
        ByteToInfo =
            new()
            {
                // 对于固定负载长度的标签：fieldSize是负载长度
                // 对于动态负载长度的标签：fieldSize是存储负载长度的字节数
                { 0, (NbtTagEnum.End, 0, false, null) },
                { 1, (NbtTagEnum.Byte, 1, false, null) },
                { 2, (NbtTagEnum.Short, 2, false, null) },
                { 3, (NbtTagEnum.Int, 4, false, null) },
                { 4, (NbtTagEnum.Long, 8, false, null) },
                { 5, (NbtTagEnum.Float, 4, false, null) },
                { 6, (NbtTagEnum.Double, 8, false, null) },
                { 7, (NbtTagEnum.ByteArray, 4, true, 1) },
                { 8, (NbtTagEnum.String, 2, true, 1) },
                { 9, (NbtTagEnum.List, 5, true, null) },
                { 10, (NbtTagEnum.Dictionary, 0, false, null) },
                { 11, (NbtTagEnum.IntArray, 4, true, 4) },
                { 12, (NbtTagEnum.LongArray, 4, true, 8) }
            };
